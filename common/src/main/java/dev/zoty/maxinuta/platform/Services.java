...
// one environment to another. In the context of Multiloader we use this feature to access a mock API in the common code
// that is swapped out for the platform specific implementation at runtime
public class Services {
    ...
    // another mod is loaded
    public static final IPlatformHelper PLATFORM = load(IPlatformHelper.class);

    // This code is used to load a service for the current environment. Your implementation of the service must be
    // defined manually by including a text file in the META-INF/services named with the fully qualified class name of
    // the service
    ...
    public static final <T> T load(Class<T> tClass) {
        ...
        Maxinuta.LOG.debug("Loaded {} for service {}", loadedService, tClass);
